<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="absolute left-0 top-0 z-9999 flex h-screen w-1/12 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 -translate-x-full"
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <!-- Sidebar Menu -->
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6 text-white">
            ...
            <a href="{{ route('admin.jukebox.index') }}">
                Jukebox
            </a>
        </nav>
        <!-- Sidebar Menu -->
        ...
        <div
            ...
            <h3 class="mb-1 font-semibold text-white">Version 0.1</h3>
